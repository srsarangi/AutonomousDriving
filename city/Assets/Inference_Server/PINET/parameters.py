...
class Parameters:
    ...
    # train from scratch.
    # model_path = ""
    model_path = dirname(__file__) + "/" + "savefile/"
    batch_size = 6
    x_size = 512
    y_size = 256
    resize_ratio = 8
    ...
    shadow_ratio = 0.6
    scaling_ratio = 0.2
    flip_indices = [(0, 34), (1, 35), (2, 36), (3, 37), (4, 38), (5, 39), (6, 40), (7, 41), (8, 42), (9, 43), (10, 44),
                    (11, 45), (12, 46), (13, 47), (14, 48), (15, 49), (16, 50), (17, 51)
        , (18, 52), (19, 53), (20, 54), (21, 55), (22, 56), (23, 57), (24, 58), (25, 59), (26, 60), (27, 61), (28, 62),
                    (29, 63), (30, 64), (31, 65)
