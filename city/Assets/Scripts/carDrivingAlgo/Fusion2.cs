...
public class Fusion2 : TrafficSystemVehicle
{
    ...
    //public  bool                        m_useNodeToPathToOnStart       = true;
    ...
    public int m_nodeToPathToRouteIndex = 0;
    ...
    private void TestCalculatedPath()
    {
    ...
    public virtual void Update()
    {
        ...
        Debug.Log("ListCount: " + m_nodeToPathToRoute.Count);
